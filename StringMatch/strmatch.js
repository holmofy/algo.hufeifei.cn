...
cljs.core.with_meta = function with_meta(b, c) {
  return cljs.core.fn_QMARK_.call(null, b) && !(b ? b.cljs$lang$protocol_mask$partition0$ & 262144 || b.cljs$core$IWithMeta$ || (b.cljs$lang$protocol_mask$partition0$ ? 0 : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) : cljs.core.native_satisfies_QMARK_.call(null, cljs.core.IWithMeta, b)) ? with_meta.call(null, function() {
    "undefined" === typeof cljs.core.t27112 && (cljs.core.t27112 = function(b, c, f, g) {
      this.meta = b;
      this.o = c;
      this.with_meta = f;
      this.meta27113 = g;
    ...
    }, cljs.core.t27112.cljs$lang$type = !0, cljs.core.t27112.cljs$lang$ctorStr = "cljs.core/t27112", cljs.core.t27112.cljs$lang$ctorPrWriter = function(b, c, f) {
      return cljs.core._write.call(null, c, "cljs.core/t27112")
    }, cljs.core.t27112.prototype.call = function() {
      var b = function(b, c) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t27112.prototype.apply = function(b, c) {
      return this.call.apply(this, [this].concat(c.slice()))
    }, cljs.core.t27112.prototype.cljs$core$IFn$_invoke$arity$2 = function() {
      var b = function(b) {
      ...
      c.cljs$core$IFn$_invoke$arity$variadic = b;
      return c
    }(), cljs.core.t27112.prototype.cljs$core$Fn$ = !0, cljs.core.t27112.prototype.cljs$core$IMeta$_meta$arity$1 = function(b) {
      return this.meta27113
    }, cljs.core.t27112.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(b, c) {
      return new cljs.core.t27112(this.meta, this.o, this.with_meta, c)
    }, cljs.core.__GT_t27112 = function(b, c, f, g) {
      return new cljs.core.t27112(b, c, f, g)
    });
    return new cljs.core.t27112(c, b, with_meta, null)
...
var strmatch = {logic:{}};
strmatch.logic.common = {};
strmatch.logic.common.discrepancy_index = function(a, b, c) {
  a = cljs.core.seq.call(null, a);
  c = cljs.core.take.call(null, cljs.core.count.call(null, a), cljs.core.drop.call(null, c, cljs.core.seq.call(null, b)));
  for(b = 0;;) {
    if(cljs.core.empty_QMARK_.call(null, a) && cljs.core.empty_QMARK_.call(null, c)) {
      return!1
    }
    if(cljs.core._EQ_.call(null, cljs.core.first.call(null, a), cljs.core.first.call(null, c))) {
      b += 1, a = cljs.core.rest.call(null, a), c = cljs.core.rest.call(null, c)
    }else {
      return new cljs.core.Keyword(null, "else", "else", 1017020587) ? b : null
    }
  }
};
strmatch.logic.common.color_array = function(a, b) {
  return cljs.core.vec.call(null, cljs.core.concat.call(null, cljs.core.map.call(null, function(b) {
    return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "color", "color", 1108746965), new cljs.core.Keyword(null, "green", "green", 1112523381), new cljs.core.Keyword(null, "index", "index", 1114250308), a + b], !0)
  }, cljs.core.range.call(null, 0, b)), cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "color", "color", 1108746965), new cljs.core.Keyword(null, "red", "red", 1014017027), new cljs.core.Keyword(null, "index", "index", 1114250308), a + b], !0)], !0)))
};
strmatch.logic.boyer_moore = {};
strmatch.logic.boyer_moore.last_occurrence = function(a) {
  return function(b) {
    return a.lastIndexOf(b)
  }
};
strmatch.logic.boyer_moore.matches_at = function(a, b, c) {
  var d = cljs.core.vec.call(null, a);
  return(0 > c || !cljs.core._EQ_.call(null, d.call(null, c), b.call(null, 0))) && cljs.core.every_QMARK_.call(null, function(a) {
    return 0 > a + c || cljs.core._EQ_.call(null, d.call(null, a + c), b.call(null, a))
  }, cljs.core.range.call(null, 1, cljs.core.count.call(null, b)))
};
strmatch.logic.boyer_moore.match_index = function(a, b) {
  return cljs.core.second.call(null, cljs.core.first.call(null, cljs.core.filter.call(null, cljs.core.first, cljs.core.map.call(null, function(c) {
    return cljs.core.PersistentVector.fromArray.call(null, [strmatch.logic.boyer_moore.matches_at.call(null, a, cljs.core.vec.call(null, b), c), c], !0)
  }, cljs.core.range.call(null, cljs.core.count.call(null, a) - cljs.core.count.call(null, b), -1 - cljs.core.count.call(null, b), -1)))))
};
strmatch.logic.boyer_moore.good_suffix_for_index = function(a, b) {
  var c = cljs.core.drop.call(null, b, a);
  return strmatch.logic.boyer_moore.match_index.call(null, a, c)
};
strmatch.logic.boyer_moore.good_suffix = function(a) {
  return cljs.core.vec.call(null, cljs.core.map.call(null, function(b) {
    return strmatch.logic.boyer_moore.good_suffix_for_index.call(null, a, b)
  }, cljs.core.range.call(null, 0, cljs.core.count.call(null, a))))
};
strmatch.logic.boyer_moore.reverse_discrepancy_index = function(a, b, c) {
  b = cljs.core.take.call(null, cljs.core.count.call(null, a), cljs.core.drop.call(null, c, b));
  b = strmatch.logic.common.discrepancy_index.call(null, cljs.core.reverse.call(null, a), cljs.core.reverse.call(null, b), 0);
  return cljs.core.truth_(b) ? cljs.core.count.call(null, a) - (b + 1) : !1
};
strmatch.logic.boyer_moore.calculate_jump = function(a, b, c) {
  var d = strmatch.logic.boyer_moore.reverse_discrepancy_index.call(null, a, b, c), e = strmatch.logic.boyer_moore.good_suffix.call(null, a);
  a = strmatch.logic.boyer_moore.last_occurrence.call(null, a);
  e = e.call(null, d);
  b = a.call(null, cljs.core.nth.call(null, b, c + d));
  return d - (e < b ? e : b)
};
strmatch.logic.boyer_moore.color_array = function(a, b, c) {
  return cljs.core.concat.call(null, cljs.core.map.call(null, function(a) {
    return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "color", "color", 1108746965), new cljs.core.Keyword(null, "green", "green", 1112523381), new cljs.core.Keyword(null, "index", "index", 1114250308), a], !0)
  }, cljs.core.reverse.call(null, cljs.core.range.call(null, cljs.core.truth_(b) ? b + 1 : 0, cljs.core.count.call(null, c)))), cljs.core.truth_(b) ? cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "index", "index", 1114250308), b, new cljs.core.Keyword(null, "color", "color", 1108746965), new cljs.core.Keyword(null, "red", "red", 1014017027)], !0)], !0) : cljs.core.PersistentVector.EMPTY)
};
strmatch.logic.boyer_moore.explanation_for = function(a, b, c) {
  var d = strmatch.logic.boyer_moore.reverse_discrepancy_index.call(null, a, b, c), e = strmatch.logic.boyer_moore.good_suffix.call(null, a).call(null, d);
  a = strmatch.logic.boyer_moore.last_occurrence.call(null, a);
  b = cljs.core.nth.call(null, b, c + d);
  c = a.call(null, b);
  return null == b ? "No match found :(" : cljs.core.truth_(d) ? [cljs.core.str("discrepancy_index \x3d "), cljs.core.str(d), cljs.core.str("\x3cbr\x3e"), cljs.core.str("last_occurrence("), cljs.core.str(b), cljs.core.str(") \x3d "), cljs.core.str(c), cljs.core.str("\x3cbr\x3e"), cljs.core.str("good_suffix("), cljs.core.str(d), cljs.core.str(") \x3d "), cljs.core.str(e), cljs.core.str("\x3cbr\x3e\x3cbr\x3e"), cljs.core.str("Good Suffix gives a jump of ("), cljs.core.str(d), cljs.core.str(") - ("), 
  cljs.core.str(e), cljs.core.str(") \x3d "), cljs.core.str(d - e), cljs.core.str("\x3cbr\x3e"), cljs.core.str("Last Occurrence gives a jump of ("), cljs.core.str(d), cljs.core.str(") - ("), cljs.core.str(c), cljs.core.str(") \x3d "), cljs.core.str(d - c), cljs.core.str("\x3cbr\x3e"), cljs.core.str("So we "), cljs.core.str(e < c ? "go with Good Suffix" : e > c ? "go with Last Occurrence" : new cljs.core.Keyword(null, "else", "else", 1017020587) ? "are indifferent" : null)].join("") : new cljs.core.Keyword(null, 
  "else", "else", 1017020587) ? "Match found!" : null
};
strmatch.logic.boyer_moore.match_data = function(a, b) {
  for(var c = 0, d = cljs.core.PersistentVector.EMPTY;;) {
    var e = strmatch.logic.boyer_moore.reverse_discrepancy_index.call(null, a, b, c), f = strmatch.logic.boyer_moore.calculate_jump.call(null, a, b, c), g = strmatch.logic.boyer_moore.color_array.call(null, c, e, a), h = strmatch.logic.boyer_moore.explanation_for.call(null, a, b, c), g = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "index", "index", 1114250308), c, new cljs.core.Keyword(null, "colors", "colors", 3954028770), g, new cljs.core.Keyword(null, "explanation", "explanation", 
    4203004299), h], !0), d = cljs.core.conj.call(null, d, g);
    if(cljs.core.truth_(function() {
      var d = e;
      return cljs.core.truth_(d) ? c + cljs.core.count.call(null, a) <= cljs.core.count.call(null, b) : d
    }())) {
      c += f
    }else {
      return d
...
strmatch.logic.boyer_moore.match = function(a, b) {
  var c = strmatch.logic.boyer_moore.good_suffix.call(null, a), d = strmatch.logic.boyer_moore.last_occurrence.call(null, a);
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "animation", "animation", 2132414198), strmatch.logic.boyer_moore.match_data.call(null, a, b), new cljs.core.Keyword(null, "tables", "tables", 4427493847), cljs.core.PersistentVector.fromArray([cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["i", "Suffix Location"], !0)], !0), cljs.core.map.call(null, cljs.core.vector, cljs.core.range.call(null), c)), cljs.core.concat.call(null, 
  cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["char", "Last Occurrence"], !0)], !0), cljs.core.map.call(null, function(a) {
    return cljs.core.PersistentVector.fromArray.call(null, [a, d.call(null, a)], !0)
  }, cljs.core.distinct.call(null, a)))], !0)], !0)
};
var jayq = {util:{}};
...
strmatch.logic.brute_force = {};
strmatch.logic.brute_force.colors_for = function(a, b, c) {
  return cljs.core.vec.call(null, function() {
    var d = strmatch.logic.common.discrepancy_index.call(null, a, b, c), e = cljs.core.truth_(d) ? d : cljs.core.count.call(null, a);
    return cljs.core.concat.call(null, cljs.core.map.call(null, function(a) {
      return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "color", "color", 1108746965), new cljs.core.Keyword(null, "green", "green", 1112523381), new cljs.core.Keyword(null, "index", "index", 1114250308), a], !0)
    }, cljs.core.range.call(null, 0, e)), cljs.core.truth_(d) ? cljs.core.PersistentVector.fromArray([cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "color", "color", 1108746965), new cljs.core.Keyword(null, "red", "red", 1014017027), new cljs.core.Keyword(null, "index", "index", 1114250308), e], !0)], !0) : cljs.core.PersistentVector.EMPTY)
  }())
};
strmatch.logic.brute_force.explanation_for = function(a, b) {
  return cljs.core.truth_(b) ? [cljs.core.str("Mismatch at '"), cljs.core.str(cljs.core.nth.call(null, a, b)), cljs.core.str("', shifting by one.")].join("") : "Match found!"
};
strmatch.logic.brute_force.match_data = function() {
  var a = null, b = function(b, c) {
    return cljs.core.vec.call(null, cljs.core.reverse.call(null, a.call(null, b, c, 0, null)))
  }, c = function(a, b, c, g) {
    for(;;) {
      var h = strmatch.logic.common.discrepancy_index.call(null, a, b, c), k = strmatch.logic.brute_force.colors_for.call(null, a, b, c), k = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "index", "index", 1114250308), c, new cljs.core.Keyword(null, "colors", "colors", 3954028770), k, new cljs.core.Keyword(null, "explanation", "explanation", 4203004299), strmatch.logic.brute_force.explanation_for.call(null, a, h)], !0);
      g = cljs.core.cons.call(null, k, g);
      var l = c <= cljs.core.count.call(null, b);
      if(cljs.core.truth_(function() {
        var a = h;
        return cljs.core.truth_(a) ? l : a
      }())) {
        c += 1
      }else {
        return g
...
strmatch.logic.brute_force.match = function(a, b) {
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "animation", "animation", 2132414198), strmatch.logic.brute_force.match_data.call(null, a, b)], !0)
};
strmatch.logic.kmp_matcher = {};
strmatch.logic.kmp_matcher.proper_prefixes = function(a) {
  return cljs.core.map.call(null, function(b) {
    return cljs.core.take.call(null, b, a)
  }, cljs.core.range.call(null, 1, cljs.core.count.call(null, a)))
};
strmatch.logic.kmp_matcher.proper_suffixes = function(a) {
  return cljs.core.map.call(null, function(b) {
    return cljs.core.drop.call(null, b, a)
  }, cljs.core.range.call(null, 1, cljs.core.count.call(null, a)))
};
strmatch.logic.kmp_matcher.prefix_QMARK_ = function(a, b) {
  return cljs.core._EQ_.call(null, a, cljs.core.take.call(null, cljs.core.count.call(null, a), b))
};
strmatch.logic.kmp_matcher.fail_value = function(a, b) {
  return cljs.core.count.call(null, cljs.core.first.call(null, cljs.core.filter.call(null, function(b) {
    return strmatch.logic.kmp_matcher.prefix_QMARK_.call(null, b, a)
  }, strmatch.logic.kmp_matcher.proper_suffixes.call(null, b))))
};
strmatch.logic.kmp_matcher.explanation_for = function(a, b, c) {
  return cljs.core.truth_(b) ? [cljs.core.str("Failed at position "), cljs.core.str(b), cljs.core.str(", "), cljs.core.str("fail("), cljs.core.str(b), cljs.core.str(") \x3d "), cljs.core.str(a.call(null, b)), cljs.core.str(", "), cljs.core.str("so we can jump by "), cljs.core.str("("), cljs.core.str(b), cljs.core.str(") - ("), cljs.core.str(a.call(null, b)), cljs.core.str(") \x3d "), cljs.core.str(b - a.call(null, b)), cljs.core.str(".")].join("") : "Match found!"
};
strmatch.logic.kmp_matcher.failure_array = function(a) {
  var b = cljs.core.seq.call(null, a), b = strmatch.logic.kmp_matcher.proper_prefixes.call(null, b);
  return cljs.core.vec.call(null, cljs.core.cons.call(null, -1, cljs.core.map.call(null, function(b) {
    return strmatch.logic.kmp_matcher.fail_value.call(null, a, b)
  }, b)))
};
strmatch.logic.kmp_matcher.entry_for = function(a, b, c, d, e) {
  d = 0 > d ? 0 : d;
  var f = cljs.core.truth_(b) ? b - d : cljs.core.count.call(null, c);
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "index", "index", 1114250308), a, new cljs.core.Keyword(null, "colors", "colors", 3954028770), cljs.core.concat.call(null, strmatch.logic.common.color_array.call(null, d, f)), new cljs.core.Keyword(null, "explanation", "explanation", 4203004299), strmatch.logic.kmp_matcher.explanation_for.call(null, e, b, cljs.core.count.call(null, c))], !0)
};
strmatch.logic.kmp_matcher.match_data = function(a, b) {
  for(var c = strmatch.logic.kmp_matcher.failure_array.call(null, a), d = 0, e = cljs.core.PersistentVector.EMPTY, f = 0;;) {
    var g = strmatch.logic.common.discrepancy_index.call(null, a, b, d), h = g - c.call(null, g), h = d + h, f = strmatch.logic.kmp_matcher.entry_for.call(null, d, g, a, f, c), e = cljs.core.conj.call(null, e, f);
    f = g;
    d = cljs.core.truth_(f) ? d <= cljs.core.count.call(null, b) : f;
    if(cljs.core.truth_(d)) {
      d = h, h = e, g = c.call(null, g), e = h, f = g
    }else {
      return e
    }
  }
};
strmatch.logic.kmp_matcher.match = function(a, b) {
  return cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "animation", "animation", 2132414198), strmatch.logic.kmp_matcher.match_data.call(null, a, b), new cljs.core.Keyword(null, "tables", "tables", 4427493847), cljs.core.PersistentVector.fromArray([cljs.core.concat.call(null, cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["i", "Fail Value"], !0)], !0), cljs.core.map.call(null, cljs.core.vector, cljs.core.range.call(null), strmatch.logic.kmp_matcher.failure_array.call(null, 
  a)))], !0)], !0)
};
var clojure = {string:{}};
...
jayq.core.document_ready.call(null, function() {
  strmatch.ui.core.jump_duration = 250;
  strmatch.ui.core.wait_after_jump = 250;
  strmatch.ui.core.wait_after_fade = 500;
  strmatch.ui.core.fade_duration = 200;
  strmatch.ui.core.wait_before_jump = 500;
  strmatch.ui.core.$animate = jayq.core.$.call(null, new cljs.core.Keyword(null, "#animate", "#animate", 1025788112));
  strmatch.ui.core.$step = jayq.core.$.call(null, new cljs.core.Keyword(null, "#step", "#step", 1049768161));
  strmatch.ui.core.$reset = jayq.core.$.call(null, new cljs.core.Keyword(null, "#reset", "#reset", 2124328574));
  strmatch.ui.core.$needle_input = jayq.core.$.call(null, new cljs.core.Keyword(null, "#needle-input", "#needle-input", 892806177));
  strmatch.ui.core.$haystack_input = jayq.core.$.call(null, new cljs.core.Keyword(null, "#haystack-input", "#haystack-input", 2804624378));
  strmatch.ui.core._STAR_playback_data_STAR_ = cljs.core.PersistentArrayMap.EMPTY;
  strmatch.ui.core._STAR_playback_index_STAR_ = 0;
  strmatch.ui.core.match_fn = function() {
    return cljs.core.PersistentArrayMap.fromArray(["naive", strmatch.logic.brute_force.match, "kmp", strmatch.logic.kmp_matcher.match, "boyer_moore", strmatch.logic.boyer_moore.match], !0).call(null, cljs.core.first.call(null, jayq.core.$.call(null, ".algbutton:checked")).value)
  };
  strmatch.ui.core.color_for = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "green", "green", 1112523381), "#81F13D", new cljs.core.Keyword(null, "red", "red", 1014017027), "#FF0000", new cljs.core.Keyword(null, "white", "white", 1127006107), "#FFFFFF", new cljs.core.Keyword(null, "yellow", "yellow", 4574631910), "#FFFF00"], !0);
  strmatch.ui.core.div_width = 30;
  strmatch.ui.core.set_value_divs = function(a, b) {
    a.empty();
    for(var c = cljs.core.seq.call(null, cljs.core.map_indexed.call(null, cljs.core.vector, b)), d = null, e = 0, m = 0;;) {
      if(m < e) {
        var n = cljs.core._nth.call(null, d, m), p = cljs.core.nth.call(null, n, 0, null), n = cljs.core.nth.call(null, n, 1, null);
        jayq.core.append.call(null, a, [cljs.core.str("\x3cdiv "), cljs.core.str("style\x3d'width:"), cljs.core.str(strmatch.ui.core.div_width), cljs.core.str("px;float:left'"), cljs.core.str("id\x3d'cell"), cljs.core.str(p), cljs.core.str("'"), cljs.core.str("class\x3d'cell'"), cljs.core.str("\x3e"), cljs.core.str(cljs.core._EQ_.call(null, n, " ") ? "\x26nbsp;" : n), cljs.core.str("\x3c/div\x3e")].join(""));
        m += 1
      }else {
        if(c = cljs.core.seq.call(null, c)) {
          cljs.core.chunked_seq_QMARK_.call(null, c) ? (d = cljs.core.chunk_first.call(null, c), c = cljs.core.chunk_rest.call(null, c), p = d, e = cljs.core.count.call(null, d), d = p) : (d = cljs.core.first.call(null, c), p = cljs.core.nth.call(null, d, 0, null), n = cljs.core.nth.call(null, d, 1, null), jayq.core.append.call(null, a, [cljs.core.str("\x3cdiv "), cljs.core.str("style\x3d'width:"), cljs.core.str(strmatch.ui.core.div_width), cljs.core.str("px;float:left'"), cljs.core.str("id\x3d'cell"), 
          cljs.core.str(p), cljs.core.str("'"), cljs.core.str("class\x3d'cell'"), cljs.core.str("\x3e"), cljs.core.str(cljs.core._EQ_.call(null, n, " ") ? "\x26nbsp;" : n), cljs.core.str("\x3c/div\x3e")].join("")), c = cljs.core.next.call(null, c), d = null, e = 0), m = 0
        }else {
          return null
        }
      }
  ...
  strmatch.ui.core.color = function(a, b, c, d) {
    var e = strmatch.ui.core.color_for.call(null, b);
    jayq.core.queue.call(null, a, function() {
      jayq.core.anim.call(null, a.children([cljs.core.str("#cell"), cljs.core.str(c)].join("")), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "background-color", "background-color", 1619226998), e], !0), d);
      return jayq.core.dequeue.call(null, a)
    });
    return a
  };
  strmatch.ui.core.position_of_haystack = function() {
    return jayq.core.$.call(null, new cljs.core.Keyword(null, "#haystack", "#haystack", 2508584061)).position().left
  };
  strmatch.ui.core.queue_step = function(a) {
    var b = jayq.core.$.call(null, new cljs.core.Keyword(null, "#needle", "#needle", 962385380)), c = (new cljs.core.Keyword(null, "index", "index", 1114250308)).cljs$core$IFn$_invoke$arity$1(a), d = (new cljs.core.Keyword(null, "colors", "colors", 3954028770)).cljs$core$IFn$_invoke$arity$1(a), e = (new cljs.core.Keyword(null, "explanation", "explanation", 4203004299)).cljs$core$IFn$_invoke$arity$1(a);
    jayq.core.queue.call(null, b, function() {
      jayq.core.css.call(null, b.children(), new cljs.core.Keyword(null, "background-color", "background-color", 1619226998), "#FFFFFF");
      return jayq.core.dequeue.call(null, b)
    });
    jayq.core.anim.call(null, b, cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "left", "left", 1017222009), strmatch.ui.core.position_of_haystack.call(null) + strmatch.ui.core.div_width * c], !0), strmatch.ui.core.jump_duration).delay(strmatch.ui.core.wait_after_jump);
    a = cljs.core.seq.call(null, d);
    for(var c = null, m = d = 0;;) {
      if(m < d) {
        var n = cljs.core._nth.call(null, c, m);
        strmatch.ui.core.color.call(null, b, (new cljs.core.Keyword(null, "color", "color", 1108746965)).cljs$core$IFn$_invoke$arity$1(n), (new cljs.core.Keyword(null, "index", "index", 1114250308)).cljs$core$IFn$_invoke$arity$1(n), function() {
          var a = (new cljs.core.Keyword(null, "delay", "delay", 1109372149)).cljs$core$IFn$_invoke$arity$1(n);
          return cljs.core.truth_(a) ? a : strmatch.ui.core.fade_duration
        }()).delay(function() {
          var a = (new cljs.core.Keyword(null, "delay", "delay", 1109372149)).cljs$core$IFn$_invoke$arity$1(n);
          return cljs.core.truth_(a) ? a : strmatch.ui.core.wait_after_fade
        }());
        m += 1
      }else {
        if(a = cljs.core.seq.call(null, a)) {
          ...
          if(cljs.core.chunked_seq_QMARK_.call(null, c)) {
            a = cljs.core.chunk_first.call(null, c), m = cljs.core.chunk_rest.call(null, c), c = a, d = cljs.core.count.call(null, a), a = m
          }else {
            var p = cljs.core.first.call(null, c);
            strmatch.ui.core.color.call(null, b, (new cljs.core.Keyword(null, "color", "color", 1108746965)).cljs$core$IFn$_invoke$arity$1(p), (new cljs.core.Keyword(null, "index", "index", 1114250308)).cljs$core$IFn$_invoke$arity$1(p), function() {
              var a = (new cljs.core.Keyword(null, "delay", "delay", 1109372149)).cljs$core$IFn$_invoke$arity$1(p);
              return cljs.core.truth_(a) ? a : strmatch.ui.core.fade_duration
            }()).delay(function() {
              var a = (new cljs.core.Keyword(null, "delay", "delay", 1109372149)).cljs$core$IFn$_invoke$arity$1(p);
              return cljs.core.truth_(a) ? a : strmatch.ui.core.wait_after_fade
            }());
            a = cljs.core.next.call(null, c);
            c = null;
            d = 0
          }
          m = 0
    ...
    jayq.core.queue.call(null, b, function() {
      jayq.core.html.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, "#explanation", "#explanation", 4425932168)), e);
      return jayq.core.dequeue.call(null, b)
    });
    return b.delay(strmatch.ui.core.wait_before_jump)
  };
  strmatch.ui.core.table_html = function(a) {
    return[cljs.core.str("\x3ctable class\x3d''\x3e"), cljs.core.str("\x3ccol width\x3d'60px' /\x3e"), cljs.core.str("\x3ccol width\x3d'60px' /\x3e"), cljs.core.str(clojure.string.join.call(null, cljs.core.map.call(null, function(a) {
      return[cljs.core.str("\x3ctr\x3e"), cljs.core.str(clojure.string.join.call(null, cljs.core.map.call(null, function(a) {
        return[cljs.core.str("\x3ctd class\x3d'table-cell'\x3e"), cljs.core.str(a), cljs.core.str("\x3c/td\x3e")].join("")
      }, a)))].join("")
    }, a))), cljs.core.str("\x3c/table\x3e")].join("")
  };
  strmatch.ui.core.show_table = function(a) {
    return jayq.core.append.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, "#tables", "#tables", 1130384314)), strmatch.ui.core.table_html.call(null, a))
  };
  strmatch.ui.core.show_tables = function(a) {
    jayq.core.html.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, "#tables", "#tables", 1130384314)), "");
    a = cljs.core.seq.call(null, a);
    for(var b = null, c = 0, d = 0;;) {
      if(d < c) {
        var e = cljs.core._nth.call(null, b, d);
        strmatch.ui.core.show_table.call(null, e);
        d += 1
      }else {
        if(a = cljs.core.seq.call(null, a)) {
          b = a, cljs.core.chunked_seq_QMARK_.call(null, b) ? (a = cljs.core.chunk_first.call(null, b), c = cljs.core.chunk_rest.call(null, b), b = a, e = cljs.core.count.call(null, a), a = c, c = e) : (e = cljs.core.first.call(null, b), strmatch.ui.core.show_table.call(null, e), a = cljs.core.next.call(null, b), b = null, c = 0), d = 0
        }else {
          return null
        }
      }
  ...
  strmatch.ui.core.reset_playback = function() {
    var a = jayq.core.val.call(null, strmatch.ui.core.$needle_input), b = jayq.core.val.call(null, strmatch.ui.core.$haystack_input), c = strmatch.ui.core.match_fn.call(null).call(null, a, b), d = (new cljs.core.Keyword(null, "animation", "animation", 2132414198)).cljs$core$IFn$_invoke$arity$1(c), c = (new cljs.core.Keyword(null, "tables", "tables", 4427493847)).cljs$core$IFn$_invoke$arity$1(c);
    strmatch.ui.core.show_tables.call(null, c);
    jayq.core.html.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, "#explanation", "#explanation", 4425932168)), "");
    jayq.core.html.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, ".result", ".result", 2249941309)), [cljs.core.str('\x3cdiv id\x3d"haystack" class\x3d"monospace"\x3e\x3c/div\x3e\x3c/br\x3e'), cljs.core.str('\x3cdiv id\x3d"needle" class\x3d"monospace"\x3e\x3c/div\x3e')].join(""));
    strmatch.ui.core.set_value_divs.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, "#haystack", "#haystack", 2508584061)), b);
    strmatch.ui.core.set_value_divs.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, "#needle", "#needle", 962385380)), a);
    jayq.core.css.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, "#needle", "#needle", 962385380)), cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null, "left", "left", 1017222009), strmatch.ui.core.position_of_haystack.call(null)], !0));
    strmatch.ui.core._STAR_playback_index_STAR_ = 0;
    return strmatch.ui.core._STAR_playback_data_STAR_ = d
  };
  for(var a = cljs.core.seq.call(null, jayq.core.$.call(null, new cljs.core.Keyword(null, ".algbutton", ".algbutton", 4715594450))), b = null, c = 0, d = 0;;) {
    if(d < c) {
      var e = cljs.core._nth.call(null, b, d);
      jayq.core.delegate.call(null, jayq.core.$.call(null, e), "", new cljs.core.Keyword(null, "click", "click", 1108654330), strmatch.ui.core.reset_playback);
      d += 1
    }else {
      if(a = cljs.core.seq.call(null, a)) {
        b = a, cljs.core.chunked_seq_QMARK_.call(null, b) ? (a = cljs.core.chunk_first.call(null, b), d = cljs.core.chunk_rest.call(null, b), b = a, c = cljs.core.count.call(null, a), a = d) : (a = cljs.core.first.call(null, b), jayq.core.delegate.call(null, jayq.core.$.call(null, a), "", new cljs.core.Keyword(null, "click", "click", 1108654330), strmatch.ui.core.reset_playback), a = cljs.core.next.call(null, b), b = null, c = 0), d = 0
      }else {
        break
      }
    }
  }
  a = cljs.core.seq.call(null, cljs.core.PersistentVector.fromArray([strmatch.ui.core.$needle_input, strmatch.ui.core.$haystack_input], !0));
  b = null;
  for(d = c = 0;;) {
    if(d < c) {
      e = cljs.core._nth.call(null, b, d), jayq.core.delegate.call(null, e, "", new cljs.core.Keyword(null, "keyup", "keyup", 1115849900), strmatch.ui.core.reset_playback), d += 1
    }else {
      if(a = cljs.core.seq.call(null, a)) {
        b = a, cljs.core.chunked_seq_QMARK_.call(null, b) ? (a = cljs.core.chunk_first.call(null, b), d = cljs.core.chunk_rest.call(null, b), b = a, c = cljs.core.count.call(null, a), a = d) : (a = cljs.core.first.call(null, b), jayq.core.delegate.call(null, a, "", new cljs.core.Keyword(null, "keyup", "keyup", 1115849900), strmatch.ui.core.reset_playback), a = cljs.core.next.call(null, b), b = null, c = 0), d = 0
      }else {
        break
      }
    }
  }
  jayq.core.delegate.call(null, strmatch.ui.core.$step, "", new cljs.core.Keyword(null, "click", "click", 1108654330), function(a) {
    return strmatch.ui.core._STAR_playback_index_STAR_ < cljs.core.count.call(null, strmatch.ui.core._STAR_playback_data_STAR_) ? (strmatch.ui.core.queue_step.call(null, cljs.core.nth.call(null, strmatch.ui.core._STAR_playback_data_STAR_, strmatch.ui.core._STAR_playback_index_STAR_)), strmatch.ui.core._STAR_playback_index_STAR_ += 1) : null
  });
  jayq.core.delegate.call(null, strmatch.ui.core.$animate, "", new cljs.core.Keyword(null, "click", "click", 1108654330), function(a) {
    a = cljs.core.count.call(null, strmatch.ui.core._STAR_playback_data_STAR_);
    for(var b = cljs.core.seq.call(null, cljs.core.range.call(null, strmatch.ui.core._STAR_playback_index_STAR_, a)), c = null, d = 0, e = 0;;) {
      if(e < d) {
        var m = cljs.core._nth.call(null, c, e);
        strmatch.ui.core.queue_step.call(null, cljs.core.nth.call(null, strmatch.ui.core._STAR_playback_data_STAR_, m));
        e += 1
      }else {
        if(b = cljs.core.seq.call(null, b)) {
          c = b, cljs.core.chunked_seq_QMARK_.call(null, c) ? (b = cljs.core.chunk_first.call(null, c), e = cljs.core.chunk_rest.call(null, c), c = b, d = cljs.core.count.call(null, b), b = e) : (b = cljs.core.first.call(null, c), strmatch.ui.core.queue_step.call(null, cljs.core.nth.call(null, strmatch.ui.core._STAR_playback_data_STAR_, b)), b = cljs.core.next.call(null, c), c = null, d = 0), e = 0
        }else {
          break
        }
      }
    }
    return strmatch.ui.core._STAR_playback_index_STAR_ = a
  });
  jayq.core.delegate.call(null, strmatch.ui.core.$reset, "", new cljs.core.Keyword(null, "click", "click", 1108654330), strmatch.ui.core.reset_playback);
  return strmatch.ui.core.reset_playback.call(null)
});
